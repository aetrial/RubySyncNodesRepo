...
# Below I added the example denoted in the test, any invocation can be changed for further test but please respect the declaration, initialization
# and execution flow in order to avoid exceptions. 
